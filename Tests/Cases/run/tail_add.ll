...
define internal i64 @go_bump(i64 %arg0) {
bb0:
  %slot0 = alloca i64
...
define internal i64 @go_sum(i64 %arg0) {
bb0:
  %slot0 = alloca i64
  store i64 %arg0, ptr %slot0
  %v0 = load i64, ptr %slot0
...
bb1:
  ...
  %v3 = call i64 @go_bump(i64 %v2)
  ret i64 %v3

bb2:
  %v4 = load i64, ptr %slot0
  %v5 = call i64 @go_bump(i64 %v4)
  %v6 = load i64, ptr %slot0
  %v7 = sub i64 %v6, 1
  %v8 = call i64 @go_sum(i64 %v7)
  %v9 = add i64 %v5, %v8
  ret i64 %v9
}
